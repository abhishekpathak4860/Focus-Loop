...
//     // 1. Get User ID from the Middleware (Token)
//     // The middleware put this here. If it's missing, the middleware failed.
...
//     // 3. Create Task in Database linked to this User
//     const newTask = await prisma.task.create({
//       data: {
//         title,
//         description,
//         status: status || "PENDING", // Default to PENDING if not sent
//         userId: userId, // LINKING THE FOREIGN KEY HERE
//       },
//     });
